...
export default function Work() {
  return (
    <section id="ourWork" className="services">
      <div className="container">

        <div className="section-title">
          <h2>Our Work</h2>
          <p>Ignition work, LLC has been fortunate enough to work with the leading companies in every industry. We love to share the projects we work on which reflect our accomplishments, experiences, and skills. For years, we have helped our clients enhance and improve their web presence by providing customized solutions suitable for their business that deliver nothing less than exceptional results. Take a look at our portfolio below and if you like what you see, please get in touch with us. We'd love to hear about your project and help you in any way we can!</p> 
        </div>

        <div className="row">
          <div className="content col-xl-5 d-flex flex-column justify-content-center">
            <img src="img/services1.png" className="img-fluid" alt="img" />
          </div>
          <div className="col-xl-7">
            <h6 className="my-3">Featured Projects</h6>
              ...
              <div className="row">
                <div className="col-lg-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
                  <div className="icon-box iconbox-blue">
                    ...
                    <h4><a href="#">RightSource</a></h4>
                    <p>Content strategy, creation, and marketing that drives results</p>
                  </div>
                </div>
                ...
                <div className="col-lg-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
                  <div className="icon-box iconbox-orange ">
                    ...
                    <h4><a href="#">MBO partners</a></h4>
                    <p>The leading platform for independent workforce management</p>
                  </div>
                </div>
                ...
                <div className="col-lg-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
                  <div className="icon-box iconbox-pink">
                    ...
                    <h4><a href="">Software Unlimited</a></h4>
                    <p>Prosecutor Case Management Software & More</p>
                  </div>
                </div>
                ...
                <div className="col-lg-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                  <div className="icon-box iconbox-teal">
                    ...
                    <h4><a href="#">Iron Bytes</a></h4>
                    <p>FORGING THE WAY WITH STRONG TECHNOLOGY</p>
                  </div>
                </div>
              </div>
            </div>
